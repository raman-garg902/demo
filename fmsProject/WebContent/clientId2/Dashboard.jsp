...
<body>
	<%
		...
		{
		//if(!session.getAttribute("username").equals("clientId2")){
			if(!request.getSession().getAttribute("username").equals("clientId2") && !request.getSession().getAttribute("flag").equals("test")){
			response.sendRedirect(request.getContextPath()+"/index.jsp");
			} 
		}
	%>
  <!--  <script>
        ...
        if (sessionStorage.getItem("on_load_counter") === null || sessionStorage.getItem("on_load_counter") == 0 || sessionStorage.getItem("on_load_counter") == 1 || sessionStorage.getItem("on_load_counter") == 3 ){
