...
<%
		...
		System.out.println("inter "+session.getAttribute("username"));
...
<!-- <script>
    ...
    <div class="clientContainer">
        ...
        <input type="button" value="Go" id="go" class="goButton"><!-- <button style="float: right;" id="logout">Logout</button> -->
       	<form action=<%=request.getContextPath()%>/LogoutServlet method="get">
            <input type="submit" value="logout" style="float: right;" id="logout"/>
                 </form>
        </div>
   <script src="intermediatefile.js"></script>
</body>
</html>